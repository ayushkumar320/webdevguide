  ...
  const technologies = [
    {
      ...
      description:
        "HTML is the skeleton of every website. It provides structure and semantic meaning to web content, creating the foundation upon which all web experiences are built.",
      features: [
...
<span class="text-code-keyword">&lt;/article&gt;</span>`,
    ...
    },
    {
      ...
      description:
        "CSS transforms plain HTML into beautiful, responsive designs. It controls every visual aspect of your website, from colors and typography to complex animations and layouts.",
      features: [
...
<span class="text-code-keyword">@keyframes</span> <span class="text-code-text">fadeIn</span> {
  ...
  <span class="text-accent">to</span> { <span class="text-code-keyword">opacity</span>: <span class="text-code-string">1</span>; }
    ...
    },
    {
      ...
      description:
        "JavaScript is the programming language that powers the modern web. It adds interactivity, handles user events, fetches data, and creates dynamic user experiences.",
      features: [
  ...
  <span class="text-code-keyword">try</span> {
    ...
    },
    {
      ...
      description:
        "React is a powerful library for building modern user interfaces with reusable components. It makes complex UIs manageable and performant through its virtual DOM and component architecture.",
      features: [
...
<span class="text-code-keyword">function</span> <span class="text-accent">UserProfile</span>({ <span class="text-code-text">userId</span> }) {
  ...
  <span class="text-code-keyword">return</span> <span class="text-code-keyword">&lt;div&gt;</span>{<span class="text-code-text">user</span>?.<span class="text-code-text">name</span>}<span class="text-code-keyword">&lt;/div&gt;</span>;
    ...
    },
    {
      ...
      description:
        "Node.js brings JavaScript to the server, enabling full-stack development with a single language. Build scalable APIs, real-time applications, and microservices with ease.",
      features: [
...
<span class="text-code-text">app</span>.<span class="text-code-text">listen</span>(<span class="text-code-string">3000</span>, () => <span class="text-code-text">console</span>.<span class="text-code-text">log</span>(<span class="text-code-string">'Server running!'</span>));`,
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="relative py-12 sm:py-16 md:py-20 border-t border-border/50 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-primary/5 to-transparent" />
        <div className="container mx-auto px-4 text-center relative z-10">
          <h3 className="text-2xl sm:text-3xl md:text-3xl font-bold mb-3 sm:mb-4 text-foreground">
            Ready to Build the Future?
          </h3>
          <p className="text-base sm:text-lg text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
            These five technologies are your toolkit for creating amazing web
            experiences. Start with HTML, style with CSS, add logic with
            JavaScript, build interfaces with React, and power it all with
            Node.js.
          </p>
          <div className="inline-block p-4 sm:p-6 rounded-2xl bg-code-bg border border-border/50 shadow-glow-lg">
            <code className="text-code-text font-mono text-sm sm:text-base">
              <span className="text-code-keyword">while</span> (
              <span className="text-code-text">learning</span>) {"{"}
              <br />
              <span className="ml-4 text-code-text">keep</span>.
              <span className="text-code-text">building</span>();
              <br />
              {"}"}
            </code>
          </div>
