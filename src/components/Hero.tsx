      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm">
            ...
            <span className="text-sm font-medium text-primary">Interactive Learning Experience</span>
          </div>
          ...
          >
            ...
            <span className="block text-foreground mt-2">Fundamentals</span>
          </h1>
          ...
          >
            Master the essential building blocks of modern web development — from HTML structure to Node.js backend
          </p>

          {/* Interactive code block */}
          <div
            ref={codeRef}
            className="max-w-2xl mx-auto p-6 rounded-2xl bg-code-bg border border-border/50 backdrop-blur-sm shadow-glow-lg"
          >
            ...
            <code className="text-left block font-mono text-sm md:text-base leading-relaxed">
          ...
          >
            ...
            <ChevronDown className={`w-5 h-5 ${jsEnabled ? 'animate-bounce' : ''}`} />
          </button>

          {!jsEnabled && (
            <div className="mt-8 p-4 rounded-lg bg-destructive/10 border border-destructive/30">
              <p className="text-destructive font-medium">
                ⚠️ JavaScript is disabled - Animations and interactions are not available
              </p>
            </div>
          )}
        </div>
